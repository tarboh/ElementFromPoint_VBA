...
#If Win64 Then
    Public Const pIUnknownRelease As Long = 8   'Address of 2nd Function in the virtual function table of the IUIAutomationElement Interface : (8-1)th * 8 Byte
...
#Else
    Public Const pIUnknownRelease As Long = 4   'Address of 2nd Function in the virtual function table of the IUIAutomationElement Interface : (8-1)th * 4 Byte
